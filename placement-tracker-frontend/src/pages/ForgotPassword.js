...
function ForgotPassword() {
  ...
  const handleResetPassword = async (e) => {
    ...
    if (!hasLower || !hasUpper || !hasNumber || !hasSpecial || formData.newPassword.length < 6) {
      toast.error('Password must contain at least one lowercase, uppercase, number, special character (@$!%*?&) and be at least 6 characters long');
      return;
    }
          ...
          <form onSubmit={handleResetPassword}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                required
              />
              <small className="form-hint">Check your email for the OTP</small>
            </div>
            ...
            <div className="form-group">
              ...
              {formData.newPassword && (
                <small className={`password-strength ${passwordStrength.includes('✓') ? 'strong' : ''}`}>
